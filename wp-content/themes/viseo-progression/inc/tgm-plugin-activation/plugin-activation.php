...
function progression_studios_register_required_plugins() {
	...
	$plugins = array(
      ...
      array(
		...
		array(
			'name' 		=> esc_html__('One Click Demo Import', 'viseo-progression' ),
		...
		array(
			...
			'slug' 		=> 'theme-my-login',
		 'source'             => get_template_directory() . '/inc/tgm-plugin-activation/plugins/theme-my-login.6.4.16.zip', // The plugin source.
			'required' 	=> false,
		),
