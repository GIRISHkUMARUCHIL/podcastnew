...
jQuery(document).ready(function () {
  ...
  jQuery('input[name="' + redux_opts.opt_name + '[defaults]"]').click(
    function () {
  ...
  jQuery(".redux-opts-group-tab-link-a").click(function () {
    ...
    jQuery(".redux-opts-group-tab-link-li").each(function () {
      if (
        jQuery(this).attr("id") !== relid + "_section_group_li" &&
  ...
  jQuery("#redux-opts-export-code-copy").click(function () {
    if (jQuery("#redux-opts-export-link-value").is(":visible")) {
      jQuery("#redux-opts-export-link-value").fadeOut("slow");
    }
    jQuery("#redux-opts-export-code").toggle("fade");
  });

  jQuery("#redux-opts-export-link").click(function () {
    if (jQuery("#redux-opts-export-code").is(":visible")) {
      jQuery("#redux-opts-export-code").fadeOut("slow");
    }
    jQuery("#redux-opts-export-link-value").toggle("fade");
  });

  if (jQuery('#menu_type option[value="push-menu"]').prop("selected")) {
    jQuery("tr.classic-menu").hide();
    jQuery("tr.elementor-menu").hide();
    jQuery(
      ".redux-opts-group-tab:not(#5_section_group) tr.classic-menu"
    ).addClass("hide-redux-option");
    jQuery(
      ".redux-opts-group-tab:not(#5_section_group) tr.elementor-menu"
    ).addClass("hide-redux-option");
    jQuery(
      ".redux-opts-group-tab:not(#5_section_group) tr.push-menu"
    ).removeClass("hide-redux-option");
  }
  if (jQuery('#menu_type option[value="classic-menu"]').prop("selected")) {
    jQuery("tr.push-menu").hide();
    jQuery("tr.elementor-menu").hide();
    jQuery(".redux-opts-group-tab:not(#5_section_group) tr.push-menu").addClass(
      "hide-redux-option"
    );
    jQuery(
      ".redux-opts-group-tab:not(#5_section_group) tr.elementor-menu"
  ...
  if (jQuery('#menu_type option[value="elementor-menu"]').prop("selected")) {
    jQuery("tr.push-menu").hide();
    jQuery("tr.classic-menu").hide();
    jQuery(".redux-opts-group-tab:not(#5_section_group) tr.push-menu").addClass(
      "hide-redux-option"
    ...
    jQuery("#4_section_group_li").addClass("hide-redux-option"); // hide logo options in the sidebar
  }
});
