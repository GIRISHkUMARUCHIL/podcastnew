...
function __construct($field = array(), $value ='', $parent = array() ) {
    ...
    */
    function render() {
        echo '<p class="description" style="color:red;">' . wp_kses( __('The fonts provided below are free to use custom fonts from the <a href="http://www.google.com/webfonts" target="_blank">Google Web Fonts directory</a>', 'sonaar'),iron_get_allowed_html()) . '</p>';
