...
class Redux_Options_sorter extends Redux_Options {
    ...
    function enqueue() {
        ...
        wp_register_script('options-sorter', Redux_OPTIONS_URL . 'fields/sorter/sorter.js', array(
            'jquery'));
        wp_register_style('options-sorter', Redux_OPTIONS_URL . 'fields/sorter/sorter.css');
