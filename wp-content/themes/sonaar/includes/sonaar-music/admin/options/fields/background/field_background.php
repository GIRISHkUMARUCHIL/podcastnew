...
class Redux_Options_background {
	...
	function render() {
		...
		echo ' <a data-update="Select File" data-choose="Choose a File" href="javascript:void(0);"class="redux-opts-upload button-secondary"' . $upload . ' rel-id="' . $this->field['id'] . '-file">' . esc_html__('Upload', 'sonaar') . '</a>';
		echo ' <a href="javascript:void(0);" class="redux-opts-upload-remove"' . $remove . ' rel-id="' . $this->field['id'] . '-file">' . esc_html__('Remove Upload', 'sonaar') . '</a>';

		echo '<br><br>';

		echo '<label>'.esc_html__('Upload Background Image', 'sonaar').'</label> ';
		...
		if(!in_array($field_id, $this->hide)) {
			...
			echo '<i class="help icon-info-sign icon-large" data-placement="bottom" data-content="'.esc_attr($info).'"></i> <label>'.esc_html__('Background Repeat', 'sonaar').'</label> ';
		...
		if(!in_array($field_id, $this->hide)) {
			...
			echo '<i class="help icon-info-sign icon-large" data-placement="bottom" data-content="'.esc_attr($info).'"></i> <label>'.esc_html__('Background Size', 'sonaar').'</label> ';
		...
		if(!in_array($field_id, $this->hide)) {
			...
			echo '<i class="help icon-info-sign icon-large" data-placement="bottom" data-content="'.esc_attr($info).'"></i> <label>'.esc_html__('Background Position', 'sonaar').'</label> ';
		...
		if(!in_array($field_id, $this->hide)) {
			...
			echo '<i class="help icon-info-sign icon-large" data-placement="bottom" data-content="'.esc_attr($info).'"></i> <label>'.esc_html__('Background Attachment', 'sonaar').'</label> ';
		...
		if(!in_array($field_id, $this->hide)) {
			...
			echo '<i class="help icon-info-sign icon-large" data-placement="bottom" data-content="'.esc_attr($info).'"></i> <label>'.esc_html__('Background Color', 'sonaar').'</label> ';
