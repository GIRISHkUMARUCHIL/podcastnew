<?php
require_once( IRON_MUSIC_DIR_PATH . 'admin/options/fields/text/field_text.php');
require_once( IRON_MUSIC_DIR_PATH . 'admin/options/fields/select/field_select.php');
require_once( IRON_MUSIC_DIR_PATH . 'admin/options/fields/color/field_color.php');
...
class Redux_Options_typography {
	...
	function render() {
		...
		$font = ( isset( $this->value['font']) )? $this->value['font'] : '';
		...
		<tr>
			...
			<?php
				...
				echo '<label>'.esc_html__('Text Align', 'sonaar').'</label> ';
			...
			<?php
				...
				echo '<label>'.esc_html__('Font Size', 'sonaar').'</label> ';
		...
		<tr>
			...
			<?php
				...
				echo '<label>'.esc_html__('Transform', 'sonaar').'</label> ';
			...
			<?php
				...
				echo '<label>'.esc_html__('Line Height', 'sonaar').'</label> ';
		...
		<tr>
			...
			<?php
				...
				echo '<label>'.esc_html__('Font Weight', 'sonaar').'</label> ';
		...
		<tr>
			...
			<?php
				...
				echo '<label>'.esc_html__('Font Color', 'sonaar').'</label> ';
			...
			<?php
				...
				echo '<label>'.esc_html__('Background', 'sonaar').'</label> ';
