<?php
class Iron_Music_Widget extends WP_Widget {
	...
	public static function get_title_divider() {
		$divider_image = sonaar_music_get_option('widget_title_divider_image');
		$divider_color = sonaar_music_get_option('widget_title_divider_color');
		$divider_margin_top = sonaar_music_get_option('widget_title_divider_margin_top');
		$divider_margin_bottom = sonaar_music_get_option('widget_title_divider_margin_bottom');
		if(empty($divider_image)){
			...
			echo '<img class="custom-header-img" style="margin-top:'.$divider_margin_top.'px; margin-bottom:'.$divider_margin_bottom.'px;" src="'.$divider_image.'"alt="divider" />';
		}
	}

	public static function is_widget_title_uppercase() {
		$widget_title_uppercase = (bool)sonaar_music_get_option('widget_title_uppercase');
