...
$wizard = new Merlin(
	...
	$config = array(
		...
		'merlin_url'           => 'sonaar-setup', // The wp-admin page slug where Merlin WP loads.
		'parent_slug'          => 'themes.php', // The wp-admin parent page slug for the admin menu item.
		'capability'           => 'manage_options', // The capability required for this menu to be displayed to the user.
		'child_action_btn_url' => 'https://www.wpbeginner.com/glossary/child-theme/', // URL for the 'child-action-link'.
		...
		'ready_big_button_url' => admin_url( 'admin.php?page=iron_options&tab=0' ), // Link for the big button on the ready step.
	),
	$strings = array(
		...
		'welcome%s'                => esc_html__( 'This wizard will set up your theme and install the required plugins. It is optional & should take only a few minutes.', '@@textdomain' ),
		...
		'plugins'                  => esc_html__( 'Let\'s install some essential WordPress plugins to get this theme runs smooth.', '@@textdomain' ),
		...
		'plugins-action-link'      => esc_html__( 'Advanced View', '@@textdomain' ),
		...
		'ready-header'             => esc_html__( 'Wonderful! Only 2 last important steps!', '@@textdomain' ),

		/* translators: Theme Author */
		'ready%s'                  => esc_html__( 'Make sure your theme is activated with your Sonaar\'s license key. Once it\'s done, you will be asked to import the theme demo.', '@@textdomain' ),
		'ready-action-link'        => esc_html__( 'Extras', '@@textdomain' ),
		'ready-big-button'         => esc_html__( 'Activate my License Key', '@@textdomain' ),
		'ready-link-1'             => sprintf( '<a href="%1$s" target="_blank">%2$s</a>', 'https://sonaar.io/video-tutorials/', esc_html__( 'Watch Video Tutorial', '@@textdomain' ) ),
		'ready-link-2'             => sprintf( '<a href="%1$s" target="_blank">%2$s</a>', 'https://support.sonaar.io/', esc_html__( 'Get Support', '@@textdomain' ) ),
		'ready-link-3'             => sprintf( '<a href="%1$s">%2$s</a>', admin_url( 'admin.php?page=iron_options&tab=0' ), esc_html__( 'Customize Theme Options', '@@textdomain' ) ),
	)
);
