...
?>
	...
	<?php if ( $iron_sonaar_archive_page ) { ?>
				<li><a href="<?php echo esc_url($iron_sonaar_archive_page); ?>"><i class="fa-solid fa-plus"></i> <?php esc_html_e("All", 'sonaar'); ?></a></li>
	<?php } ?>
	...
	?>
				<li><a class="<?php echo esc_attr($iron_sonaar_activeClass); ?>" href="<?php echo esc_url(get_term_link( $term, $taxonomy )); ?>"><i class="fa-solid fa-plus"></i> <?php echo esc_html($term->name); ?></a></li>
	<?php endforeach; ?>
			</ul>
		</nav>
	</section>
